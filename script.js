...
function searchData(){
    ...
    for(let i =0;i<myJson.length;i++){
        ...
        if(myJson[i].first_name.toLowerCase().includes(input.value.toLowerCase()) || myJson[i].last_name.toLowerCase().includes(input.value.toLowerCase()) || myJson[i].email.toLowerCase().includes(input.value.toLowerCase())){
